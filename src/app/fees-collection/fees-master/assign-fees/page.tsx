...
import rawClassGeneral from './Class1General';

const classGeneral: Fee[] = rawClassGeneral.map((fee: any) => ({
  feesCode: fee.feesCode,
  amount: (fee.amount),
}));
import studentDataRaw from './student';

const studentData: Student[] = studentDataRaw.map((s: any) => ({
  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-5 mt-3 gap-5">
        <div>
          <label>Class</label>
          <select className="w-full" value={selectedClass} onChange={(e: ChangeEvent<HTMLSelectElement>) => setSelectedClass(e.target.value)}>
        ...
        <div>
          <label>Section</label>
          <select className="w-full" value={selectedSection} onChange={(e: ChangeEvent<HTMLSelectElement>) => setSelectedSection(e.target.value)}>
            <option value="">Select</option>
        ...
        <div>
          ...
          <select className="w-full" value={category} onChange={(e: ChangeEvent<HTMLSelectElement>) => setCategory(e.target.value)}>
            <option value="">Select</option>
        ...
        <div>
          <label>Gender</label>
          <select className="w-full" value={gender} onChange={(e: ChangeEvent<HTMLSelectElement>) => setGender(e.target.value)}>
            <option value="">Select</option>
        ...
        <div>
          <label>RTE</label>
          <select className="w-full" value={RTE} onChange={(e: ChangeEvent<HTMLSelectElement>) => setRTE(e.target.value)}>
            <option value="">Select</option>

...
export default function FeesCarry() {
  ...
  function handleSearch() {
    ...
    setBalance(filtered.filter(balance=>{
        ...
        <div className="p-6">
          ...
          <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-6 mb-6">
            <div className='w-full'>
              ...
              {(showContent && className==="") && <p className='text-red-600' >Fill this class field</p>}
            </div>
            <div className='w-full'>
              ...
              { (showContent && section==="") && <p className='text-red-600' >Fill this section field</p>}
          ...
          {(showContent && className!=="" && section!=="") && <div>
            ...
            <div className="overflow-x-auto">
              <div className="grid lg:grid-cols-2 sm:grid-cols-1 mb-4 space-x-2">
                ...
                <div className='text-end' >
                  ...
                  className="p-1 text-gray-600 hover:text-gray-800"  ><Database className="w-5 h-5" /></button>
                  <button 
                  onClick={handleExportExcel}
                  className="p-1 text-gray-600 hover:text-gray-800" ><Download className="w-5 h-5" /></button>
                  <button 
                  onClick={handleCopy}
                  className="p-1 text-gray-600 hover:text-gray-800" ><Copy className="w-5 h-5" /></button>
                  <button 
                  onClick={handlePrint}
                  className="p-1 text-gray-600 hover:text-gray-800" ><Printer className="w-5 h-5" /></button>
                </div>
              </div>

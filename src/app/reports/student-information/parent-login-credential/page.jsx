              ...
              <table style={{ 
                ...
                <thead>
                  <tr style={{ backgroundColor: '#f2f2f2' }}>
                    ...
                    <th style={{ padding: '12px', textAlign: 'left', borderBottom: '1px solid #ddd', fontWeight: 'bold' }}> Parent Username</th>
                    <th style={{ padding: '12px', textAlign: 'left', borderBottom: '1px solid #ddd', fontWeight: 'bold' }}> Parent Password</th>
                  </tr>
                </thead>
                <tbody>

...
export default function AddItemReport() {
  ...
  const handleSearch = () => {
    ...
    if (filters.searchQuery) {
      ...
      results = results.filter(item => 
        ...
        item.purchasePrice.toLowerCase().includes(query) ||
        item.date.includes(filters.searchQuery)
      );
    }
 ...
 <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      {/* Search Input */}
      <h1 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '20px' }}>Add Item Report</h1>
            ...
            <table style={{ 
              ...
              <thead>
                <tr style={{ backgroundColor: '#f3f4f6' }}>
                  ...
                  <th style={{ padding: '10px', border: '1px solid #e5e7eb', textAlign: 'left' }}>Purchase Price</th>
              ...
              <tbody>
                {filteredData.map((item, index) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '10px', border: '1px solid #e5e7eb' }}>{item.purchasePrice}</td>
                    <td style={{ padding: '10px', border: '1px solid #e5e7eb' }}>{item.date}</td>
                  </tr>
                ))}
              </tbody>
            </table>

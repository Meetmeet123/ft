...
const IncomeReport = () => {
  ...
  const [searchType, setSearchType] = useState("This Month");
  ...
  const handleSearch = () => {
    ...
    if (searchQuery) {
      ...
      results = results.filter(item => 
        ...
        item.incomeHead.toLowerCase().includes(query)
      );
    }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h3 style={{ margin: '0', color: '#333' }}>Search Type *</h3>
        <select 
          style={{
            padding: '6px 10px',
            border: '1px solid #ddd',

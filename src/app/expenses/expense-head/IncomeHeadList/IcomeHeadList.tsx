...
const IncomeHead = [
  {
    id: 1,
    IncomeHead: "Student Attendance is less",
  },
...
const IncomeHeadList = () => {
  ...
  const filteredComplainTypes = IncomeHead.filter((type) =>
    type.IncomeHead.toLowerCase().includes(searchText.toLowerCase())
  );

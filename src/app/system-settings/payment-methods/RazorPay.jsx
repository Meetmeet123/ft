...
import razorpayLogo from './assets/razorpay.jpg'; // Adjust the path as necessary
...
const RazorpayGatewayForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log({ keyId, keySecret, feesType, amount });
  };
    ...
    <div className="flex flex-col md:flex-row md:space-x-45 xl:w-[100%] mx-auto">
      <form onSubmit={handleSubmit} className="w-full md:w-3/5 lg:w-3/5 mb-8 md:mb-0 space-y-4">
        ...
        <div className="flex items-center space-x-4">
          <label htmlFor="keyId" className="w-48 font-medium">
            Razorpay Key ID<span className="text-red-500 ml-1">*</span>
          </label>
          <input
            type="text"
            id="keyId"
        ...
        {/* Razorpay Key Secret */}
        <div className="flex items-center space-x-4">
          <label htmlFor="keySecret" className="w-48 font-medium">
            Razorpay Key Secret<span className="text-red-500 ml-1">*</span>
          </label>
          <input
            type="password"
            id="keySecret"

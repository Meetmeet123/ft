...
import billplzLogo from "./assets/billplz.jpg"; // Adjust the path as necessary

const BillplzConfigForm = () => {
      ...
      >
        <div className="space-y-3">
          ...
          <div className="flex items-center space-x-4">
            <label htmlFor="apiKey" className="w-48 font-medium">
          ...
          <div className="flex items-center space-x-4">
            <label htmlFor="customerServiceEmail" className="w-48 font-medium">
        ...
        <div className="flex my-4">
          <Image
            ...
            onError={(e) => {
              ...
              e.target.src = "https://www.billplz.com/assets/logo.png";
            }}
          />
        </div>
        <a
...
export default BillplzConfigForm;

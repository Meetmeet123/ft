...
function Student() {
  const [students, setStudents] = useState<StudentType[]>(studentData);
  const [searchQuery, setSearchQuery] = useState<string>("");
  const [filteredStudents, setFilteredStudents] = useState<StudentType[]>(studentData);
  ...
  const toggleActive = (admissionNo: string) => {

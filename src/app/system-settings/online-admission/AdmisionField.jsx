...
const OnlineAdmissionFormFields = () => {
  const [toggles, setToggles] = useState(Array(fields.length).fill(false));
  ...
  const handlePrintClick = () => {
    const content = document.getElementById('fields-table').innerHTML;

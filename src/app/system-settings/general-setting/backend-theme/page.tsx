...
import BackendThemepage from "./BackendThemepage/BackendThemepage";

const GeneralSettings = () => {
    const pathname = usePathname();
    const [activeLink, setActiveLink] = useState("backend-theme");
    ...
    useEffect(() => {
        ...
        if (path.includes("backend-theme")) {
    ...
    return (
        <div className="mt-10 h-fit flex flex-row px-5 intro-y ">
            {/* Side Submenu (20%) */}

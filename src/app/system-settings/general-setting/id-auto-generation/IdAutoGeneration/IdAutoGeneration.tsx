...
// Interface for the settings data structure
interface SettingDetails {
  staffid_auto_insert?: string;
  staffid_no_digit?: string;
  staffid_start_from?: string;
}

const IdAutoGeneration: React.FC = () => {
    ...
    const [buttonStates, setButtonStates] = useState<boolean[]>([false, false]);

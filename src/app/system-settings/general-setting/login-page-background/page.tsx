...
import LoginPageBackground from "./LoginPageBackground/LoginPageBackground";

const GeneralSettings = () => {
    const pathname = usePathname();
    const [activeLink, setActiveLink] = useState("login-page-background");
    ...
    const renderContent = () => {
        switch (activeLink) {
            ...
            case "login-page-background":
                return <div><LoginPageBackground /></div>;
            case "backend-theme":
    ...
    return (
        <div className="mt-10 h-fit flex flex-row ml-4 intro-y " style={{ marginLeft: "120px" }}>
            {/* Side Submenu (20%) */}

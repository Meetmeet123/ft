...
import LogoThemepage from "./LogoTheme/LogoThemepage";
...
const GeneralSettings = () => {
    ...
    const renderContent = () => {
        switch (activeLink) {
            ...
            case "signature":
                return <div>Signature Content</div>;
    ...
    return (
        <div className="mt-6 h-fit flex flex-row pl-4 intro-y " style={{ marginLeft: "120px" }}>
            {/* Side Submenu (20%) */}

...
const LogoThemepage = () => {
    ...
    const handlePrintLogo = async () => {
        ...
        try {
            ...
            console.log('Error updating print logo:', error);
    ...
    const handleAdminLogo = async () => {
        ...
        try {
            const formData = new FormData();
            formData.append('id', settingDetails.id.toString());
            formData.append('file', adminLogoFile); // 'file' is correct here
            ...
            // Removed console.error to avoid showing error in the console
    ...
    const handleAdminSmallLogo = async () => {
        ...
        try {
            const formData = new FormData();
            formData.append('id', settingDetails.id.toString());
            formData.append('file', adminSmallLogoFile); // Use 'file' as the key
    ...
    const handleAppLogo = async () => {
        ...
        try {
            const formData = new FormData();
            formData.append('id', settingDetails.id.toString());
            formData.append('file', appLogoFile);

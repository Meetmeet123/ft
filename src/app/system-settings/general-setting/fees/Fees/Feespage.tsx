...
const Feespage: React.FC = () => {
  ...
  const toggleCheckbox1 = (): void => setIsChecked1(!isChecked1);
  const toggleCheckbox2 = (): void => setIsChecked2(!isChecked2);
  const toggleCheckbox3 = (): void => setIsChecked3(!isChecked3);

  const [isEnabled, setIsEnabled] = useState<boolean>(true); // State to track the radio button selection
  // Creating an array of states for each radio button group
  const [buttonStates, setButtonStates] = useState<boolean[]>([true, true, true, true]); // Each item represents the enabled/disabled state for a group
    ...
    <div className="bg-white p-3 mb-3">
      ...
      <form className="">
        <div className="flex flex-col">
          ...
          {/* Group 4 */}
          <div className="lg:flex md:block items-center mt-4">
            <label htmlFor="" className='w-1/3 mt-4'>Fees Fine</label>
            <div className="flex items-center mt-4">
              <input
                id="default-radio-7"
                type="radio"

...
export default function Index(){
  ...
  return (
    ...
    <div className="mobile-menu md:hidden">
        <div className="mobile-menu-bar">
            <a href="" className="flex mr-auto">
                <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="w-6" src="./public/logo.svg" />
            </a>
            ...
            <ul className="scrollable__content py-2">
                ...
                <li>
                    ...
                    <ul className="">
                        ...
                        <li>
                            <a href="side-menu-light-Image  width={24} height={24}-zoom.html" className="menu">
                                <div className="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div className="menu__title"> Image  width={24} height={24} Zoom </div>
                            </a>
                        </li>
                    </ul>
                </li>
    ...
    <div className="top-bar-boxed h-[70px] md:h-[65px] z-[51] border-b border-white/[0.08] mt-12 md:mt-0 -mx-3 sm:-mx-8 md:-mx-0 px-3 md:border-b-0 relative md:fixed md:inset-x-0 md:top-0 sm:px-8 md:px-10 md:pt-10 md:bg-gradient-to-b md:from-slate-100 md:to-transparent dark:md:from-darkmode-700">
        <div className="h-full flex items-center">
            <a href="" className="logo -intro-x hidden md:flex xl:w-[180px] block">
                <Image  width={24} height={24} alt="Midone - HTML Admin Template"  className="logo__Image  width={24} height={24} w-6" src="./public/logo.svg" />
            ...
            <div className="intro-x relative mr-3 sm:mr-6">
                ...
                <div className="search-result">
                    <div className="search-result__content">
                        ...
                        <div className="mb-5">
                            <a href="" className="flex items-center mt-2">
                                <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                    <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-full" src="./public/profile-15.jpg" />
                                </div>
                            ...
                            <a href="" className="flex items-center mt-2">
                                <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                    <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-full" src="./public/profile-7.jpg" />
                                </div>
                            ...
                            <a href="" className="flex items-center mt-2">
                                <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                    <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-full" src="./public/profile-12.jpg" />
                                </div>
                            ...
                            <a href="" className="flex items-center mt-2">
                                <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                    <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-full" src="./public/profile-1.jpg" />
                                </div>
                        ...
                        <a href="" className="flex items-center mt-2">
                            <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-full" src="./public/preview-1.jpg" />
                            </div>
                        ...
                        <a href="" className="flex items-center mt-2">
                            <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-full" src="./public/preview-14.jpg" />
                            </div>
                        ...
                        <a href="" className="flex items-center mt-2">
                            <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-full" src="./public/preview-3.jpg" />
                            </div>
                        ...
                        <a href="" className="flex items-center mt-2">
                            <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-full" src="./public/preview-11.jpg" />
                            </div>
            ...
            <div className="intro-x dropdown mr-4 sm:mr-6">
                ...
                <div className="notification-content pt-2 dropdown-menu">
                    <div className="notification-content__box dropdown-content">
                        ...
                        <div className="cursor-pointer relative flex items-center mt-5">
                            <div className="w-12 h-12 flex-none Image  width={24} height={24}-fit mr-1">
                                <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-full" src="./public/profile-11.jpg" />
                                <div className="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                            </div>
                            <div className="ml-2 overflow-hidden">
                                <div className="flex items-center">
            ...
            <div className="intro-x dropdown w-8 h-8">
                <div className="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg Image  width={24} height={24}-fit zoom-in scale-110" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                    <Image  width={24} height={24} alt="Midone - HTML Admin Template" src="./public/profile-5.jpg" />
                </div>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul className="">
                        ...
                        <li>
                            <a href="side-menu-light-Image  width={24} height={24}-zoom.html" className="side-menu">
                                <div className="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div className="side-menu__title"> Image  width={24} height={24} Zoom </div>
                            </a>
                        </li>
                    </ul>
                </li>
                            ...
                            <div className="report-box-2 intro-y mt-5">
                                <div className="box grid grid-cols-12">
                                    <div className="col-span-12 lg:col-span-4 px-8 py-12 flex flex-col justify-center">
                                        <i data-lucide="pie-chart" className="w-10 h-10 text-pending"></i> 
                                        <div className="justify-start flex items-center text-slate-600 dark:text-slate-300 mt-12"> My Total Assets <i data-lucide="alert-circle" className="tooltip w-4 h-4 ml-1.5" title="Total value of your sales: $158.409.416"></i> </div>
                                        <div className="flex items-center justify-start mt-4">
                                            <div className="relative text-2xl font-medium pl-3 ml-0.5"> <span className="absolute text-xl font-medium top-0 left-0 -ml-0.5">$</span> 1,413,102.02 </div>
                                            <a className="text-slate-500 ml-4" href=""> <i data-lucide="refresh-ccw" className="w-4 h-4"></i> </a>
                                        </div>
                                    ...
                                    <div className="col-span-12 lg:col-span-8 p-8 border-t lg:border-t-0 lg:border-l border-slate-200 dark:border-darkmode-300 border-dashed">
                                        <ul className=" nav nav-pills w-60 border border-slate-300 dark:border-darkmode-300 border-dashed rounded-md mx-auto p-1 mb-8 " role="tablist" >
                                            <li id="weekly-report-tab" className="nav-item flex-1" role="presentation">
                                                <button className="nav-link w-full py-1.5 px-2 active" data-tw-toggle="pill" data-tw-target="#weekly-report" type="button" role="tab" aria-controls="weekly-report" aria-selected="true" > Weekly </button>
                                            </li>
                                            <li id="monthly-report-tab" className="nav-item flex-1" role="presentation">
                                                <button className="nav-link w-full py-1.5 px-2" data-tw-toggle="pill" data-tw-target="#monthly-report" type="button" role="tab" aria-selected="false" > Monthly </button>
                                            </li>
                                        </ul>
                                        <div className="tab-content px-5 pb-5">
                                            <div className="tab-pane active grid grid-cols-12 gap-y-8 gap-x-10" id="weekly-report" role="tabpanel" aria-labelledby="weekly-report-tab">
                        ...
                        <div className="col-span-12 lg:col-span-8 xl:col-span-4 mt-6">
                            ...
                            <div className="mt-5">
                                <div className="intro-y">
                                    <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-md overflow-hidden">
                                            <Image  width={24} height={24} alt="Midone - HTML Admin Template" src="./public/profile-13.jpg" />
                                        </div>
                                        <div className="ml-4 mr-auto">
                                            <div className="font-medium">Russell Crowe</div>
                                            <div className="text-slate-500 text-xs mt-0.5">18 June 2022</div>
                                        </div>
                                ...
                                <div className="intro-y">
                                    <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-md overflow-hidden">
                                            <Image  width={24} height={24} alt="Midone - HTML Admin Template" src="./public/profile-8.jpg" />
                                        </div>
                                        <div className="ml-4 mr-auto">
                                            <div className="font-medium">Robert De Niro</div>
                                            <div className="text-slate-500 text-xs mt-0.5">16 November 2021</div>
                                        </div>
                                        <div className="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">137 Sales</div>
                                    </div>
                                </div>
                                <div className="intro-y">
                                    <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-md overflow-hidden">
                                            <Image  width={24} height={24} alt="Midone - HTML Admin Template" src="./public/profile-15.jpg" />
                                        </div>
                                        <div className="ml-4 mr-auto">
                                            <div className="font-medium">Tom Cruise</div>
                                            <div className="text-slate-500 text-xs mt-0.5">28 May 2020</div>
                                        </div>
                                        <div className="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">137 Sales</div>
                                    </div>
                                </div>
                                <div className="intro-y">
                                    <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-md overflow-hidden">
                                            <Image  width={24} height={24} alt="Midone - HTML Admin Template" src="./public/profile-7.jpg" />
                                        </div>
                                        <div className="ml-4 mr-auto">
                                            <div className="font-medium">Angelina Jolie</div>
                                            <div className="text-slate-500 text-xs mt-0.5">30 March 2022</div>
                                        </div>
                                        <div className="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">137 Sales</div>
                                    </div>
                                </div>
                        ...
                        <div className="col-span-12 md:col-span-6 lg:col-span-4 mt-6">
                            ...
                            <div className="intro-y box p-5 mt-12 sm:mt-5">
                                ...
                                <div className="flex items-center mb-5">
                                    <div className="flex items-center">
                                        <div>Site Visits</div>
                                        <div className="text-danger flex text-xs font-medium tooltip cursor-pointer ml-2" title="49% Higher than last month"> -2% <i data-lucide="chevron-down" className="w-4 h-4 ml-0.5"></i> </div>
                                    </div>
                                ...
                                <div className="flex items-center mb-5">
                                    <div className="flex items-center">
                                        <div>Page Views</div>
                                        <div className="text-success flex text-xs font-medium tooltip cursor-pointer ml-2" title="49% Higher than last month"> 5% <i data-lucide="chevron-up" className="w-4 h-4 ml-0.5"></i> </div>
                                    </div>
                                ...
                                <div className="flex items-center mb-5">
                                    <div className="flex items-center">
                                        <div>% New Visits</div>
                                        <div className="text-danger flex text-xs font-medium tooltip cursor-pointer ml-2" title="49% Higher than last month"> -9% <i data-lucide="chevron-down" className="w-4 h-4 ml-0.5"></i> </div>
                                    </div>
                                ...
                                <button className="btn btn-outline-secondary w-full border-slate-300 dark:border-darkmode-300 border-dashed relative justify-start mb-2">
                                    ...
                                    <span className="w-8 h-8 absolute flex justify-center items-center right-0 top-0 bottom-0 my-auto ml-auto mr-0.5"> <i data-lucide="arrow-right" className="w-4 h-4"></i> </span>
                                </button>
                            </div>
                        </div>
                        <div className="col-span-12 md:col-span-6 lg:col-span-4 mt-6">
                                    ...
                                    <tbody>
                                            ...
                                            <td className="w-40">
                                                <div className="flex">
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-10.jpg" title="Uploaded at 18 June 2022" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-2.jpg" title="Uploaded at 10 August 2022" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-13.jpg" title="Uploaded at 7 October 2020" />
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr className="intro-x">
                                            <td className="w-40">
                                                <div className="flex">
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-3.jpg" title="Uploaded at 16 November 2021" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-4.jpg" title="Uploaded at 22 April 2021" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-15.jpg" title="Uploaded at 28 October 2022" />
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr className="intro-x">
                                            <td className="w-40">
                                                <div className="flex">
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-1.jpg" title="Uploaded at 28 May 2020" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-1.jpg" title="Uploaded at 15 May 2021" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-15.jpg" title="Uploaded at 16 September 2021" />
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr className="intro-x">
                                            <td className="w-40">
                                                <div className="flex">
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-13.jpg" title="Uploaded at 30 March 2022" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-1.jpg" title="Uploaded at 16 September 2020" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="./public/preview-15.jpg" title="Uploaded at 24 May 2022" />
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                            ...
                            <div className="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 mt-3">
                                ...
                                <div className="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
                                    <div className="intro-x relative flex items-center mb-3">
                                        <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                            <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-full overflow-hidden">
                                                <Image  width={24} height={24} alt="Midone - HTML Admin Template" src="./public/profile-3.jpg" />
                                            </div>
                                        </div>
                                    ...
                                    <div className="intro-x relative flex items-center mb-3">
                                        <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                            <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-full overflow-hidden">
                                                <Image  width={24} height={24} alt="Midone - HTML Admin Template" src="./public/profile-4.jpg" />
                                            </div>
                                        </div>
                                        <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            <div className="flex items-center">
                                            ...
                                            <div className="text-slate-500">
                                                ...
                                                <div className="flex mt-2">
                                                    <div className="tooltip w-8 h-8 Image  width={24} height={24}-fit mr-1 zoom-in" title="Nike Air Max 270">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-md border border-white" src="./public/preview-4.jpg" />
                                                    </div>
                                                    <div className="tooltip w-8 h-8 Image  width={24} height={24}-fit mr-1 zoom-in" title="Dell XPS 13">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-md border border-white" src="./public/preview-4.jpg" />
                                                    </div>
                                                    <div className="tooltip w-8 h-8 Image  width={24} height={24}-fit mr-1 zoom-in" title="Dell XPS 13">
                                                        <Image  width={24} height={24} alt="Midone - HTML Admin Template" className="rounded-md border border-white" src="./public/preview-4.jpg" />
                                    ...
                                    <div className="intro-x relative flex items-center mb-3">
                                        <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                            <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-full overflow-hidden">
                                                <Image  width={24} height={24} alt="Midone - HTML Admin Template" src="./public/profile-11.jpg" />
                                            </div>
                                        </div>
                                        <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            <div className="flex items-center">
                                            ...
                                            <div className="text-slate-500 mt-1">Has changed <a className="text-primary" href="">Samsung Q90 QLED TV</a> price and description</div>
                                        </div>
                                    </div>
                                    <div className="intro-x relative flex items-center mb-3">
                                        <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                            <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-full overflow-hidden">
                                                <Image  width={24} height={24} alt="Midone - HTML Admin Template" src="./public/profile-6.jpg" />
                                            </div>
                                        </div>
                                        <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            <div className="flex items-center">
                                            ...
                                            <div className="text-slate-500 mt-1">Has changed <a className="text-primary" href="">Nike Tanjun</a> description</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="mt-5">
                                    ...
                                    <div className="intro-x">
                                        <div className="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            ...
                                            <div className="ml-4 mr-auto">
                                                <div className="font-medium">Robert De Niro</div>
                                                <div className="text-slate-500 text-xs mt-0.5">15 June 2020</div>
                                            </div>
    ...
    <div data-url="side-menu-dark-dashboard-overview-4.html" className="dark-mode-switcher cursor-pointer shadow-md fixed bottom-0 right-0 box dark:bg-dark-2 border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-10 mr-10">

    ...
    <div className="mobile-menu md:hidden">
        <div className="mobile-menu-bar">
            <a href="" className="flex mr-auto">
                <Image  width={24} height={24} alt="Admin Panel" className="w-6" src="./public/logo.svg" />
            </a>
    ...
    <div className="top-bar-boxed h-[70px] md:h-[65px] z-[51] border-b border-white/[0.08] mt-12 md:mt-0 -mx-3 sm:-mx-8 md:-mx-0 px-3 md:border-b-0 relative md:fixed md:inset-x-0 md:top-0 sm:px-8 md:px-10 md:pt-10 md:bg-gradient-to-b md:from-slate-100 md:to-transparent dark:md:from-darkmode-700">
        <div className="h-full flex items-center">
            <a href="" className="logo -intro-x hidden md:flex xl:w-[180px] block">
                <Image  width={24} height={24} alt="Admin Panel"  className="logo__Image  width={24} height={24} w-6" src="./public/logo.svg" />
            ...
            <div className="intro-x relative mr-3 sm:mr-6">
                ...
                <div className="search-result">
                    <div className="search-result__content">
                        ...
                        <div className="mb-5">
                            <a href="" className="flex items-center mt-2">
                                <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                    <Image  width={24} height={24} alt="Admin Panel" className="rounded-full" src="./public/profile-15.jpg" />
                                </div>
                            ...
                            <a href="" className="flex items-center mt-2">
                                <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                    <Image  width={24} height={24} alt="Admin Panel" className="rounded-full" src="./public/profile-7.jpg" />
                                </div>
                            ...
                            <a href="" className="flex items-center mt-2">
                                <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                    <Image  width={24} height={24} alt="Admin Panel" className="rounded-full" src="./public/profile-12.jpg" />
                                </div>
                            ...
                            <a href="" className="flex items-center mt-2">
                                <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                    <Image  width={24} height={24} alt="Admin Panel" className="rounded-full" src="./public/profile-1.jpg" />
                                </div>
                        ...
                        <a href="" className="flex items-center mt-2">
                            <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                <Image  width={24} height={24} alt="Admin Panel" className="rounded-full" src="./public/preview-1.jpg" />
                            </div>
                        ...
                        <a href="" className="flex items-center mt-2">
                            <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                <Image  width={24} height={24} alt="Admin Panel" className="rounded-full" src="./public/preview-14.jpg" />
                            </div>
                        ...
                        <a href="" className="flex items-center mt-2">
                            <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                <Image  width={24} height={24} alt="Admin Panel" className="rounded-full" src="./public/preview-3.jpg" />
                            </div>
                        ...
                        <a href="" className="flex items-center mt-2">
                            <div className="w-8 h-8 Image  width={24} height={24}-fit">
                                <Image  width={24} height={24} alt="Admin Panel" className="rounded-full" src="./public/preview-11.jpg" />
                            </div>
            ...
            <div className="intro-x dropdown mr-4 sm:mr-6">
                ...
                <div className="notification-content pt-2 dropdown-menu">
                    <div className="notification-content__box dropdown-content">
                        ...
                        <div className="cursor-pointer relative flex items-center mt-5">
                            <div className="w-12 h-12 flex-none Image  width={24} height={24}-fit mr-1">
                                <Image  width={24} height={24} alt="Admin Panel" className="rounded-full" src="./public/profile-11.jpg" />
                                <div className="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                            </div>
                            <div className="ml-2 overflow-hidden">
                                <div className="flex items-center">
            ...
            <div className="intro-x dropdown w-8 h-8">
                <div className="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg Image  width={24} height={24}-fit zoom-in scale-110" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                    <Image  width={24} height={24} alt="Admin Panel" src="./public/profile-5.jpg" />
                </div>
                        ...
                        <div className="col-span-12 lg:col-span-8 xl:col-span-4 mt-6">
                            ...
                            <div className="mt-5">
                                <div className="intro-y">
                                    <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-md overflow-hidden">
                                            <Image  width={24} height={24} alt="Admin Panel" src="./public/profile-13.jpg" />
                                        </div>
                                ...
                                <div className="intro-y">
                                    <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-md overflow-hidden">
                                            <Image  width={24} height={24} alt="Admin Panel" src="./public/profile-8.jpg" />
                                        </div>
                                        <div className="ml-4 mr-auto">
                                ...
                                <div className="intro-y">
                                    <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-md overflow-hidden">
                                            <Image  width={24} height={24} alt="Admin Panel" src="./public/profile-15.jpg" />
                                        </div>
                                        <div className="ml-4 mr-auto">
                                ...
                                <div className="intro-y">
                                    <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-md overflow-hidden">
                                            <Image  width={24} height={24} alt="Admin Panel" src="./public/profile-7.jpg" />
                                        </div>
                                        <div className="ml-4 mr-auto">
                                    ...
                                    <tbody>
                                            ...
                                            <td className="w-40">
                                                <div className="flex">
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-10.jpg" title="Uploaded at 18 June 2022" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-2.jpg" title="Uploaded at 10 August 2022" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-13.jpg" title="Uploaded at 7 October 2020" />
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr className="intro-x">
                                            <td className="w-40">
                                                <div className="flex">
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-3.jpg" title="Uploaded at 16 November 2021" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-4.jpg" title="Uploaded at 22 April 2021" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-15.jpg" title="Uploaded at 28 October 2022" />
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr className="intro-x">
                                            <td className="w-40">
                                                <div className="flex">
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-1.jpg" title="Uploaded at 28 May 2020" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-1.jpg" title="Uploaded at 15 May 2021" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-15.jpg" title="Uploaded at 16 September 2021" />
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr className="intro-x">
                                            <td className="w-40">
                                                <div className="flex">
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-13.jpg" title="Uploaded at 30 March 2022" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-1.jpg" title="Uploaded at 16 September 2020" />
                                                    </div>
                                                    <div className="w-10 h-10 Image  width={24} height={24}-fit zoom-in -ml-5">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="tooltip rounded-full" src="./public/preview-15.jpg" title="Uploaded at 24 May 2022" />
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                            ...
                            <div className="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 mt-3">
                                ...
                                <div className="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
                                    <div className="intro-x relative flex items-center mb-3">
                                        <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                            <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-full overflow-hidden">
                                                <Image  width={24} height={24} alt="Admin Panel" src="./public/profile-3.jpg" />
                                            </div>
                                        </div>
                                    ...
                                    <div className="intro-x relative flex items-center mb-3">
                                        <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                            <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-full overflow-hidden">
                                                <Image  width={24} height={24} alt="Admin Panel" src="./public/profile-4.jpg" />
                                            </div>
                                        </div>
                                        <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            <div className="flex items-center">
                                            ...
                                            <div className="text-slate-500">
                                                ...
                                                <div className="flex mt-2">
                                                    <div className="tooltip w-8 h-8 Image  width={24} height={24}-fit mr-1 zoom-in" title="Nike Air Max 270">
                                                        <Image  width={24} height={24} alt="Admin Panel" className="rounded-md border border-white" src="./public/preview-4.jpg" />
                                                    </div>
                                    ...
                                    <div className="intro-x relative flex items-center mb-3">
                                        <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                            <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-full overflow-hidden">
                                                <Image  width={24} height={24} alt="Admin Panel" src="./public/profile-11.jpg" />
                                            </div>
                                        </div>
                                        <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            <div className="flex items-center">
                                    ...
                                    <div className="intro-x relative flex items-center mb-3">
                                        <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                            <div className="w-10 h-10 flex-none Image  width={24} height={24}-fit rounded-full overflow-hidden">
                                                <Image  width={24} height={24} alt="Admin Panel" src="./public/profile-6.jpg" />
                                            </div>
                                        </div>
                                        <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            <div className="flex items-center">

...
import ComplainTypeForm from "./ComplainTypeForm/ComplainTypeFrom";
import ComplainTypeList from "./ComplainTypeList/ComplainTypeList";

const SetupFrontOffice = () => {
  const pathname = usePathname();
  const [activeLink, setActiveLink] = useState("complain-type");
  ...
  return (
    <div className="mt-10 h-fit flex flex-row px-5" style={{ marginLeft: "120px" }}>
      {/* Side Submenu (20%) */}
      <div className="w-1/5">
        <div className="relative min-h-[200px]"> {/* Added container with relative positioning */}

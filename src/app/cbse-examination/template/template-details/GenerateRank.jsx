...
function GenerateRank({onClose}) {
  return (
    <div className="fixed w-full left-1 z-60 top-20 transform p-4 bg-blue-50 rounded shadow-lg max-h-[80vh] overflow-y-auto">
  ...
  <div className="w-full overflow-x-auto">
    <table className="table-auto w-full min-w-[800px] border-collapse border border-gray-300 text-sm">
      <thead>
        <tr className="bg-gray-100">
          <th className="border px-2 py-1 text-left">Admission No</th>
          <th className="border px-2 py-1 text-left">Student Name</th>
          <th className="border px-2 py-1 text-left">Class</th>
          <th className="border px-2 py-1 text-left">Father Name</th>
          <th className="border px-2 py-1 text-left">Date of Birth</th>
          <th className="border px-2 py-1 text-left">Gender</th>
          <th className="border px-2 py-1 text-left">Mobile No</th>

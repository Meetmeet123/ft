...
export default function SchoolReports() {
 ...
 const pathname = usePathname();
  ...
  const classRankData = [
    { rank: 1, class: 'Class 5',section:'A', students: 18, totalPoints: 260 },
    { rank: 2, class: 'Class 4',  section:'B',students: 15, totalPoints: 230 },
    { rank: 3, class: 'Class 1',  section:'C'  ,students: 5, totalPoints: 190 },
    { rank: 4, class: 'Class 2', section: 'D',students: 6, totalPoints: 150 },
    { rank: 5, class: 'Class 3',  section:'A',students: 8, totalPoints: 70 },
  ];
...
const viewIncidents = (student) => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {activeTab === 'rank' ? (
        <div>
          <h2 className="text-xl font-semibold mb-4">Class Section Wise Rank Report</h2>
          <div className="mb-4">
            <input
              type="text"
              placeholder="Search..."
              ...
              <tbody>
                {classRankData.map((item) => (
                  <tr key={item.rank} className="hover:bg-gray-50">
                    ...
                    <td className="py-2 px-4 border text-center">{item.class}({item.section})</td>

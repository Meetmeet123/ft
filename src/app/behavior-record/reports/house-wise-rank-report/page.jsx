...
export default function SchoolReports() {
  ...
  const classRankData = [
    { rank: 1, house: 'Blue', students: 18, totalPoints: 260 },
    { rank: 2, house: 'Green', students: 15, totalPoints: 230 },
    { rank: 3, house: 'Red ', students: 5, totalPoints: 190 },
    { rank: 4, house: 'Yellow ', students: 6, totalPoints: 150 },
    // { rank: 5, house: 'Class 3', students: 8, totalPoints: 70 },
  ];
  ...
  return (
    <div className="container mx-auto p-4">
     <div style={{
      ...
      {activeTab === 'rank' ? (
        <div>
          <h2 className="text-xl font-semibold mb-4">House Wise Rank Report</h2>
          <div className="mb-4">
            <input
              type="text"
              placeholder="Search..."
            ...
            <table className="min-w-full bg-white border">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="py-2 px-4 border">House</th>
              ...
              <tbody>
                {classRankData.map((item) => (
                  <tr key={item.rank} className="hover:bg-gray-50">
                    ...
                    <td className="py-2 px-4 border text-center">{item.house}</td>

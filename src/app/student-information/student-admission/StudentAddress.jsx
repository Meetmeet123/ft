...
export default function StudentAddressForm() {
  ...
  const [displaStudentAddressForm, setDisplayStudentAddressForm] = useState(false);
  ...
  return (
    <div className="w-full" >
        <div onClick={()=>setDisplayStudentAddressForm(!displaStudentAddressForm)}
